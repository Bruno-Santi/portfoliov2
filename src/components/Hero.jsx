  ...
  return (
    <section className='min-h-screen flex flex-col justify-start items-center p-5 text-center'>
      ...
      <p className='max-w-2xl text-xl font-light text-gray-400'>
        ...
        Soy un desarrollador front-end con experiencia en la creación de experiencias web impactantes y funcionales. Mi
        enfoque está en la tecnología y la creatividad, y mi objetivo es impulsar el éxito de los proyectos a través de
